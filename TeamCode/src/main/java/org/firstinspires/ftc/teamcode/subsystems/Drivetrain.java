...
public class Drivetrain extends MecanumDrive implements Subsystem {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(20, 5, 5,
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(0.2, 0.02, 0.01);
